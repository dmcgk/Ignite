...
extension Site {
    ...
    public var scriptingEnabled: Bool { true }

    /// Enable the Ignite site generator meta-tag by default.
    public var igniteSiteGeneratorMetaTagEnabled: Bool { true }

    /// Enable the OpenGraph meta tags by default.
    public var openGraphMetaTagsEnabled: Bool { true }

    /// Enable the Twitter meta tags by default.
    public var twitterMetaTagsEnabled: Bool { true }

    public var themeBase: ThemeBase { .light }
